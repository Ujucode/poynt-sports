  ...
  return (
    <div className="flex-wrap text-center top-0 py-4">
      ...
      <p className="mb-2 text-lg font-normal text-gray-600 lg:text-xl sm:px-16 xl:px-48 dark:text-gray-400">
        ...
        teams and athletes. From strategic masterminds to motivational Gurus, we
        bring you the profiles of top-notch coaches who have made a significant
        impact in their respective sports. Get ready to learn from the best!
      </p>

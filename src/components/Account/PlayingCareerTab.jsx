...
const PlayingCareerTab = () => {
  ...
  return (
    ...
    >
      ...
      <TextField label="Address Line" fullWidth name="address-line" />

      <TextField label="City/Town/Village" fullWidth name="city-town-village" />
      ...
      <TextField label="Contact Number" fullWidth name="contact" />

      <TextField
        label="Club/Team/Player Profile URL"
        fullWidth
      ...
      <TextField label="Address Line" fullWidth name="address-previous" />
